...
public class MealServlet extends HttpServlet {
    ...
    @Override
    public void init() {
        repository = InMemoryMealRepository.getRepository();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        User user = SecurityUtil.getUser(request);
        if (user != null) {
            ...
            MealTo meal = new MealTo(id.isEmpty() ? null : Integer.valueOf(id),
                    ...
                    false);
            mealRestController.doPost(meal, user);
            ...
            switch (action == null ? "all" : action) {
                ...
                case "update":
                    final Meal meal = "create".equals(action) ?
                            ...
                            repository.get(getId(request), user.getId());
